...
if (isset($_GET['del'])) {
	...
	$obj->del_registro(intval($_GET['del']));
}
$rs = $obj->showregistro();
?>
										...
										<tbody>
											...
											while ($res = $rs->fetch_object()) { ?>
												<tr class="odd gradeX">
													...
													<td><?php echo mb_strtoupper($res->nombre1 . ' ' . $res->nombre2 . ' ' . $res->apellido1 . ' ' . $res->apellido2); ?></td>
													<td><?php echo $res->telefonono; ?></td>
													<td><?php echo mb_strtolower($res->correo); ?></td>
													<td>&nbsp;&nbsp;
														<a href="editar_registro.php?cid=<?php echo $res->idusuario; ?>">
															<p class="fa fa-edit"></p>
														</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<a href="mirar_registro.php?del=<?php echo $res->idusuario; ?>">
